        ...
        <form onSubmit={handleSignup} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 transition text-black"
              required
            />
          </div>
          <div>
...
>
  ...
  Signup Now
                              ...
                              {/* Google login */}
                              <a
                                  href="https://web-staging-cc40.up.railway.app/accounts/login/google-oauth2/?next=https://cricket-zeta-hazel.vercel.app/login"
