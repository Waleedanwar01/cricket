                    ...
                    {bookings.map((b) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-sm">
                            <span
                              className={`px-2 py-1 rounded text-xs font-medium ${b.status === "cancelled"
                          ...
                          <td className="px-4 py-3 text-sm">
                            <span
                              className={`px-2 py-1 rounded text-xs font-medium ${b.payment_status === "paid"
                                  ? "bg-green-900/40 text-green-300"
                          ...
                          <td className="px-4 py-3 text-right text-sm">
                            <button
                              ...
                              className={`px-3 py-2 rounded border text-white transition ${cancellingId === b.id
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-right text-sm">
                          <button
                            ...
                            className={`px-3 py-2 rounded border text-white transition ${cancellingTournamentId === t.id
                                ? "opacity-70 cursor-not-allowed border-gray-600"
                                : t.status === "cancelled"
                                  ? "opacity-50 cursor-not-allowed border-gray-700"
                                  : "hover:bg-red-600/20 border-red-600"
